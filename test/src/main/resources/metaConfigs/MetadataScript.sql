...
CREATE INDEX SEEDS_INDEX ON SEEDS(ID);
CREATE INDEX RAW_NEWS_INDEX ON RAW_NEWS(ID);
CREATE INDEX TRANSFORMED_NEWS_INDEX ON TRANSFORMED_NEWS(ID);
CREATE INDEX ANALYZED_NEWS_INDEX ON ANALYZED_NEWS(ID);
