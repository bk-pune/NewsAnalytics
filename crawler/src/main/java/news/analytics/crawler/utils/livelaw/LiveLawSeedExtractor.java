package news.analytics.crawler.utils.livelaw;
...
public class LiveLawSeedExtractor extends AbstractSeedExtractor {
    public LiveLawSeedExtractor(String archiveLinksFileName) {
    ...
    public List<String> extract(String rawHtml) throws IOException {
        ...
        for(int i = 0; i<anchors.size(); i++) {
            ...
            if(href.startsWith("/top-stories/")) { // only same domain urls
                seeds.add(href);
            }
        }
        return seeds;
